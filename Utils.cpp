...
template<>
bool _Vector2<float>::equalApproximately(const _Vector2<float>& other) const {
	return distance(other) < 0.5f;
}
template<>
bool _Vector2<int>::equalApproximately(const _Vector2<int>& other) const {
	return *this == other;
}
template<>
